...
# productos que se encuentran dentro del inventario en la venta de productos de la cafeteria de Tecmilenio
Productos = [
...
# Menú principal:
# establece las opciones a elegir dentro del programa para darle mayor funcion y revision a la venta diaria o incluso mensual
def menu():
    print("\n       MENÚ PRINCIPAL      ")
...
# Registrar productos:
# en la primera opcion se define el registro de productos que se puedan agregar dentro de las alimentos que vende la cafeteria
